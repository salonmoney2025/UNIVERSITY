          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Add part-time, distance learning, and special students</p>
              </div>
            </div>
            <Link
              href="/dashboard"
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200 p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-600">Evening or weekend students</p>
              </button>
              ...
              >
                ...
                <p className="text-sm text-gray-600">Remote or online students</p>
              </button>
              ...
              >
                ...
                <p className="text-sm text-gray-600">Certificate or diploma students</p>
              </button>
            </div>
          </div>
