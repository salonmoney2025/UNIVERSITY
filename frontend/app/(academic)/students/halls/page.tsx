          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Student Accommodation Management</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Total Halls</h3>
              <p className="text-3xl font-bold text-black mt-2">4</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Total Capacity</h3>
              <p className="text-3xl font-bold text-black mt-2">650</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Occupied</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">585</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Available</h3>
            ...
            <div className="px-6 py-4 border-b border-solid black-200 flex justify-between items-center">
              ...
              <div className="flex space-x-3">
                <input
                  ...
                  className="px-4 py-2 border border-solid black-300 rounded-md bg-white text-black focus:ring-2 focus:ring-teal-500"
                />
