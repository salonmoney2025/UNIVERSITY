      ...
      <div className="p-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Manage exams and results</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm text-gray-600">Total Exams</h3>
            <p className="text-3xl font-bold text-black mt-2">24</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm text-gray-600">Scheduled</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm text-gray-600">Pending Results</h3>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600">Manage examinations, schedules and results</p>
        </div>
      </div>
    </DashboardLayout>
  );
