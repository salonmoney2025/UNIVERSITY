          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Financial analytics and reporting</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              ...
              <p className="text-3xl font-bold text-green-600 mt-2">NSL 245M</p>
              <p className="text-sm text-green-600 mt-2">↑ 15% from last month</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Outstanding Fees</h3>
              <p className="text-3xl font-bold text-orange-600 mt-2">NSL 42M</p>
              <p className="text-sm text-black mt-2">17% of total</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Transactions</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">2,456</p>
              <p className="text-sm text-black mt-2">This month</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Collection Rate</h3>
