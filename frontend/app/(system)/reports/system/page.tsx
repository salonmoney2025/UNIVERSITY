...
import { FileBarChart, Home, Download, Settings } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">System usage and performance analytics</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              ...
              <p className="text-sm text-black mt-2">Active accounts</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Active Sessions</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">342</p>
              <p className="text-sm text-black mt-2">Currently online</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">System Uptime</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">99.8%</p>
              <p className="text-sm text-black mt-2">Last 30 days</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Avg Response Time</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow border border-solid black-200 p-6">
              ...
              <button className="w-full px-4 py-2 bg-solid black-600 hover:bg-solid black-700 text-white rounded flex items-center justify-center space-x-2">
                <Download className="w-4 h-4" />
                <span>Generate Report</span>
              </button>
            </div>
