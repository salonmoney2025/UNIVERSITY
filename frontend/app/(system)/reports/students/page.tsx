      ...
      <div className="min-h-screen bg-solid black-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Student analytics and reporting</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Active Students</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">1,180</p>
              <p className="text-sm text-black mt-2">94.8% of total</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Average GPA</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">3.42</p>
              <p className="text-sm text-green-600 mt-2">↑ 0.08 from last sem</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Attendance Rate</h3>
              <p className="text-3xl font-bold text-purple-600 mt-2">87.5%</p>
              <p className="text-sm text-black mt-2">This semester</p>
            </div>
          </div>
