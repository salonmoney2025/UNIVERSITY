      ...
      <div className="min-h-screen bg-solid black-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Human resources analytics and reporting</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Faculty Members</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">89</p>
              <p className="text-sm text-black mt-2">57% of staff</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Admin Staff</h3>
              <p className="text-3xl font-bold text-purple-600 mt-2">67</p>
              <p className="text-sm text-black mt-2">43% of staff</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Avg Attendance</h3>
