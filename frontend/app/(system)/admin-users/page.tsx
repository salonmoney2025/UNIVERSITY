    ...
    <div className="min-h-screen bg-solid black-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6 border border-solid black-200">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-solid black-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-black">Staff</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-solid black-200">
          {filteredUsers.length > 0 ? (
              ...
              <table className="min-w-full divide-y divide-solid black-200">
                ...
                <tbody className="bg-white divide-y divide-solid black-200">
                  {filteredUsers.map((user) => (
                    <tr key={user.id} className="hover:bg-solid black-50">
            ...
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="mt-2 text-sm font-medium text-black">No users found</h3>
              <p className="mt-1 text-sm text-black">
                {searchTerm || filterRole !== 'all' || filterStatus !== 'all'
