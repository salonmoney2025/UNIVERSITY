          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Manage staff benefits and allowances</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Total Staff</h3>
              <p className="text-3xl font-bold text-black mt-2">156</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Monthly Benefits</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">NSL 45M</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Active Benefits</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">8</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Pending Claims</h3>
                ...
                <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-black">156 staff enrolled</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-black">NSL 15,000,000</p>
                ...
                <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-black">142 staff enrolled</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-black">NSL 12,000,000</p>
                    <p className="text-sm text-black">Monthly</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-black">89 staff enrolled</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-black">NSL 18,000,000</p>
                    <p className="text-sm text-black">Monthly</p>
                  </div>
                </div>
              </div>
