      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-portal-teal-500">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-black">Block PINs</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          <div className="bg-gradient-to-br from-solid black-500 to-solid black-600 rounded-lg shadow-lg p-6 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-black uppercase tracking-wide">Total PINs</p>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-solid black-200">
                {filteredPins.map((pin, index) => (
                  <tr key={pin.id} className="hover:bg-solid black-50 transition-colors">
                    <td className="px-6 py-4 border-r border-solid black-200">
                      <span className="text-sm text-black">{index + 1}</span>
                    </td>
                    <td className="px-6 py-4 border-r border-solid black-200">
                      <span className="text-sm font-mono font-medium text-black">{pin.pinNumber}</span>
                    </td>
                    <td className="px-6 py-4 border-r border-solid black-200">
                      <span className="text-sm text-black">{pin.serialNumber}</span>
                    </td>
                    <td className="px-6 py-4 border-r border-solid black-200">
                      <span className="text-sm text-black">{pin.type}</span>
                    </td>
                    <td className="px-6 py-4 border-r border-solid black-200">
                      <span className="text-sm font-medium text-black">{pin.value.toLocaleString()}</span>
                    </td>
                    <td className="px-6 py-4 border-r border-solid black-200">
                      {getStatusBadge(pin.status)}
                    </td>
                    <td className="px-6 py-4 border-r border-solid black-200">
                      <span className="text-sm text-black">{pin.usedBy || '-'}</span>
                    </td>
          ...
          {filteredPins.length === 0 && (
            <div className="text-center py-12">
              <Shield className="h-12 w-12 text-black mx-auto mb-3" />
              <p className="text-black font-medium">No PINs found</p>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm font-medium text-black">Serial Number</p>
                        <p className="text-sm text-black">{selectedPin.serialNumber}</p>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-black">Type</p>
                        <p className="text-sm text-black">{selectedPin.type}</p>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-black">Value</p>
                        <p className="text-sm text-black">NSL {selectedPin.value.toLocaleString()}</p>
                      </div>
                      <div>
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-2 border-2 border-solid black-300 rounded focus:outline-none focus:ring-2 focus:ring-red-500"
                    />
                  </div>
                </div>
