          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Manage graduation and commencement ceremonies</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Eligible Graduates</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">342</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Pending Verification</h3>
              <p className="text-3xl font-bold text-orange-600 mt-2">28</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Certificates Ready</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">298</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Graduation Date</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-black">Final deadline for verifying graduate records</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-black">Graduation ceremony rehearsal</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border-2 border-teal-500 bg-teal-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-black">Main commencement ceremony</p>
                </div>
