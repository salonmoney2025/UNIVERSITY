      ...
      <div className="min-h-screen bg-solid black-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Document and file management system</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Total Files</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Folders</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">48</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Shared Files</h3>
          ...
          <div className="bg-white rounded-lg shadow border border-solid black-200 p-6 mb-6">
            ...
            <div className="border-2 border-dashed border-solid black-300 rounded-lg p-8 text-center">
              ...
              <p className="text-black mb-2">Drag and drop files here or click to browse</p>
          ...
          {/* Files Grid */}
          <div className="bg-white rounded-lg shadow border border-solid black-200">
            <div className="px-6 py-4 border-b border-solid black-200 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-black">Recent Files</h2>
              <input
                type="search"
                placeholder="Search files..."
                className="px-4 py-2 border border-solid black-300 rounded focus:ring-2 focus:ring-teal-500 text-black"
              />
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[1, 2, 3].map((file) => (
                  <div key={file} className="border border-solid black-300 rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    <p className="text-sm text-black mb-3">2.4 MB • 2 days ago</p>
                    <button className="w-full px-4 py-2 bg-solid black-100 hover:bg-solid black-200 text-black rounded flex items-center justify-center space-x-2">
