          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-black">Manage student union elections and voting</p>
              </div>
            </div>
            <Link
              href="/dashboard"
        ...
        <div className="px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Total Voters</h3>
              <p className="text-3xl font-bold text-black mt-2">1,245</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Votes Cast</h3>
              <p className="text-3xl font-bold text-green-600 mt-2">842</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Candidates</h3>
              <p className="text-3xl font-bold text-blue-600 mt-2">12</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow border border-solid black-200">
              <h3 className="text-black text-sm font-medium">Turnout</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-black">4 candidates registered</p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-black">3 candidates registered</p>
                </div>
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">
                  Active
                </span>
              ...
              <div className="flex items-center justify-between p-4 border border-solid black-300 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-black">5 candidates registered</p>
                </div>
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">
                  Active
                </span>
