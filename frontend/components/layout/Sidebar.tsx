...
export default function Sidebar() {
  ...
  const navigationItems: NavItem[] = [
    ...
    { name: 'APPLICATION PINS', href: '/application-pins', icon: Key },
    {
    ...
    { name: 'RECONCILIATION', href: '/reconciliation', icon: Calculator },
    {
      ...
      icon: FileBarChart,
      submenu: [
        { name: 'Student Reports', href: '/reports/students', icon: FileBarChart },
        { name: 'Financial Reports', href: '/reports/financial', icon: FileBarChart },
        { name: 'HR Reports', href: '/reports/hr', icon: FileBarChart },
        { name: 'System Reports', href: '/reports/system', icon: FileBarChart },
      ],
    },
