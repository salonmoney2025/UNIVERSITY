        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassingMarks = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    Room = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Semester = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_ClassSchedules_ClassScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarksObtained = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
                    TotalMarks = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_ClassScheduleId",
                table: "Enrollments",
                column: "ClassScheduleId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClassSchedules_StaffMembers_InstructorId",
                table: "ClassSchedules",
                column: "InstructorId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Departments_StaffMembers_HeadOfDepartmentId",
                table: "Departments",
                column: "HeadOfDepartmentId",
                principalTable: "StaffMembers",
                principalColumn: "Id",
